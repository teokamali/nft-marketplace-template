...
import { StyleExploreHeaderCenterTitleText, StyleExploreHeaderOpratorBox, StyleExploreHeaderOpratorSection, StyleExploreHeaderOpratorTextBox, StyleExploreHeaderSection, StyleExploreHeaderSLeftDesc, StyleExploreHeaderSLeftTextDesc, StyleExploreHeaderSLeftTextTitle, StyleExploreMainSection, StyleExploreWraper, StyleTradingCategoriesCardBox, StyleTradingCategoriesCardImage, StyleTradingCategoriesCardText, StyleTradingCategoriesCardTextBox, StyleTradingCategoriesThumbnailBox } from "./StyleMobileExplore";
            ...
            <StyleExploreHeaderOpratorSection>
                <StyleExploreHeaderOpratorBox>
                    ...
                    <StyleExploreHeaderOpratorTextBox>
                        <StyleExploreHeaderCenterTitleText>{formatMessage({ ...messages.PHOTOGRAPHY })}</StyleExploreHeaderCenterTitleText>
                        <StyleExploreHeaderSLeftDesc>{formatMessage({ ...messages.BEFORE })}</StyleExploreHeaderSLeftDesc>
                    </StyleExploreHeaderOpratorTextBox>
                </StyleExploreHeaderOpratorBox>
                <StyleExploreHeaderOpratorBox>
                    <StyleExploreHeaderOpratorTextBox>
                        <StyleExploreHeaderCenterTitleText>{formatMessage({ ...messages.MUSIC })}</StyleExploreHeaderCenterTitleText>
                        <StyleExploreHeaderSLeftDesc>{formatMessage({ ...messages.NEXT })}</StyleExploreHeaderSLeftDesc>
                    </StyleExploreHeaderOpratorTextBox>
