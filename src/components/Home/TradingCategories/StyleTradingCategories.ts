...
export const StyleTradingCategorieDropDown = styled.div`
    ${tw` shadow-md rounded-[10px] absolute top-[40px] bg-white right-0 flex flex-col px-[15px] py-[10px] gap-[10px]  text-black dark:text-white`}
`;
export const StyleTradingCategorieDropDownText = styled.span`
    ${tw`text-[18px] cursor-pointer py-[2px] border-b-[1px] border-black hover:bg-[#E5EAF0]`}
`;
