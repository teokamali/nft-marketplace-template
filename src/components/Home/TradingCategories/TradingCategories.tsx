...
import { StyleTradingCategorieDropDown, StyleTradingCategorieDropDownText, StyleTradingCategoriesButton, StyleTradingCategoriesCardBox, StyleTradingCategoriesCardImage, StyleTradingCategoriesCardMobile, StyleTradingCategoriesCardText, StyleTradingCategoriesCardTextBox, StyleTradingCategoriesSection, StyleTradingCategoriesSectionMobile, StyleTradingCategoriesSliderSection, StyleTradingCategoriesThumbnailBox, StyleTradingCategoriesTitleBox, StyleTradingCategoriesTitleDesc, StyleTradingCategoriesTitleDescMobile, StyleTradingCategoriesTitleText, StyleTradingCategoriesTitleTextMobile, StyleTradingCategoriesTitleTextone, StyleTradingCategoriesTitleTextoneMobile, StyleTradingCategoriesTitleTextTow } from "./StyleTradingCategories"
                ...
                <StyleTradingCategoriesSection >
                    <StyleTradingCategoriesTitleBox>
                        <StyleTradingCategoriesTitleText>
                            ...
                            <StyleTradingCategoriesTitleTextTow onClick={handleOpen}>
                                {formatMessage({ ...messages.ALL_CATEGORIES })}
                                <svg width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.33301 0.666992L7.99967 7.33366L14.6663 0.666993" stroke="#5F6DF1" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>

                            </StyleTradingCategoriesTitleTextTow>
                            {TradingCategoriesd && (
                                <StyleTradingCategorieDropDown style={{ zIndex: "11" }}>
                                    {itemDropdown.map((item, index) => {
                                        return (
                                            <StyleTradingCategorieDropDownText key={index}>
                                                {item}
                ...
                <StyleTradingCategoriesSectionMobile>
                    <StyleTradingCategoriesTitleBox>
                        <StyleTradingCategoriesTitleText>
                            ...
                            <StyleTradingCategoriesTitleTextMobile onClick={handleOpen}>
                                {formatMessage({ ...messages.ALL_CATEGORIES })}
                                <svg width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.33301 0.666992L7.99967 7.33366L14.6663 0.666993" stroke="#5F6DF1" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
