...
import { StyledHeader, StyledHeaderLogoVMenu, StyledHeaderOprator } from "pages/Home/homeStyles";
...
const HeaderHome = () => {
    return (<StyledHeader>
        <StyledHeaderLogoVMenu>
            <svg className="h-7 w-7 text-gray-800" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3 " stroke-linecap="round" stroke-linejoin="round">
