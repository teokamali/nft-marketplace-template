            ...
            <StyleCollectionMainWrapper>
                ...
                <StyleCollectionMainHeaderItemFilterBox >
                    <StyleCollectionMainHeaderItemFilterBoxHeader filterVisible={filterVisible} >
                        ...
                        <StyledCollectionIconWrapper onClick={() => { setFilterVisible(!filterVisible) }}>
                            {!filterVisible ? <ChevronUpIcon /> : <ChevronDownIcon />}
                        </StyledCollectionIconWrapper>
                    </StyleCollectionMainHeaderItemFilterBoxHeader>
                    <StyleCollectionMainBodyFilter filterVisible={filterVisible} >
                        <StyleCollectionMainHeaderItemFilterBodyBox >
                            <StyleCollectionMainHeaderItemFilterBodyItemHeaderBox >
                                <StyleCollectionMainHeaderItemFilterBodyItemHeaderNameBox>
                                    Status
                                </StyleCollectionMainHeaderItemFilterBodyItemHeaderNameBox>
                                <StyledCollectionIconWrapper onClick={() => { setStatusVisible(!statusVisible) }}>
                                    {!statusVisible ? <ChevronUpIcon /> : <ChevronDownIcon />}
                                </StyledCollectionIconWrapper>
                            </StyleCollectionMainHeaderItemFilterBodyItemHeaderBox >
                            <StyleCollectionMainHeaderItemFilterBodyItemBoxStatus statusVisible={statusVisible}>
                                {filterStatus.map((status, index) => {
                                    return (
                                        <>
                                            <StyleCollectionMainItemFilterBodyItemBox key={index}>
                        ...
                        <StyleCollectionMainHeaderItemFilterBodyBox >
                            <StyleCollectionMainHeaderItemFilterBodyItemHeaderBox >
                                ...
                                <StyledCollectionIconWrapper onClick={() => { setQuantityVisible(!quantityVisible) }}>
                                    {!quantityVisible ? <ChevronUpIcon /> : <ChevronDownIcon />}
                                </StyledCollectionIconWrapper>
                            </StyleCollectionMainHeaderItemFilterBodyItemHeaderBox >
                            <StyleCollectionMainHeaderItemFilterBodyItemBoxQuantity quantityVisible={quantityVisible}>
                        ...
                        <StyleCollectionMainHeaderItemFilterBodyBox >
                            <StyleCollectionMainHeaderItemFilterBodyItemHeaderBox >
                                ...
                                <StyledCollectionIconWrapper onClick={() => { setCurrencyVisible(!currencyVisible) }}>
                                    {!currencyVisible ? <ChevronUpIcon /> : <ChevronDownIcon />}
                                </StyledCollectionIconWrapper>
                            </StyleCollectionMainHeaderItemFilterBodyItemHeaderBox >
                            <StyleCollectionMainHeaderItemFilterBodyItemBoxCurrency currencyVisible={currencyVisible}>
                        ...
                        <StyleCollectionMainHeaderItemFilterBodyBox style={{ border: "none" }}>
                            <StyleCollectionMainHeaderItemFilterBodyItemHeaderBox >
                                <StyleCollectionMainHeaderItemFilterBodyItemHeaderNameBox>
                        ...
                        <StyleCollectionMainFilterPriceBodyItemBox>
                            ...
                            <StyleCollectionMainHeaderItemFilterBodyPriceBox>
                                <StyleCollectionMainItemFilterBodyItemPriceInput type="number" placeholder="MIN" style={{ outline: "none", width: "30px" }} />
                            </StyleCollectionMainHeaderItemFilterBodyPriceBox>
                            {formatMessage({ ...messages.TO })}
                            <StyleCollectionMainHeaderItemFilterBodyPriceBox>
                                <StyleCollectionMainItemFilterBodyItemPriceInput type="number" placeholder="MAX" style={{ outline: "none", width: "33px" }} />
                            </StyleCollectionMainHeaderItemFilterBodyPriceBox>
                        </StyleCollectionMainFilterPriceBodyItemBox>
