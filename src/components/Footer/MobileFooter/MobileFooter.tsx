...
import { DescriptionDesc, DescriptionTile, DescriptionTileDesc, MenuFooterSection, MenuSection, MenuText, MenuTitle, SectionTitleBox, SectionWraper, SocialBox, SocialIcon, SocialSection, SocialTitle } from "./StyleMobileFooter"
