...
import { LanguageVsWalletSection, MenuItem, MenuSection, SearchBox, Section, Title } from "./StyleMobileHeader"
...
import { openMenuDropDown, openSearchInput, openWalletDropDown } from "src/redux/slices/modals/modalsSlice"
import { DescriptionDropDoun, DropDounBox, MenuDropDoun, MenuDropDounItem, MenuDropDounItemImg, MenuDropDounItemText, TitleDropDounBox, TitleDropDounText } from "./StyleMobileHeader"
                ...
                {menu && (
                    <DropDounBox>
                        ...
                        <MenuDropDoun style={{ paddingRight: "30px" }}>
                            {items.map((ic) =>
                                <MenuDropDounItemText>{ic.item}</MenuDropDounItemText>
                            )}
                        </MenuDropDoun>
                    </DropDounBox>
                )}
